...
namespace CE
{
    enum class KeyCode : int{
        ...
        Semicolon = 59, Equal = 61, LeftBracket = 91, Backslash = 92, RightBracket = 93, GraveAccent = 96
    };
    ...
    public:
        ...
        // temp until we get a game window
        static void InitDummyWindow();
        static void UpdateDummyWindow();
    };
}
